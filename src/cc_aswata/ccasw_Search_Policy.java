 ...
 * @author jsm
 */
public class ccasw_Search_Policy extends javax.swing.JFrame {
    private static String cus[]=new String[21];
    private static String condition,branchid,cobid,docid;
...
//        new Timer(1000, wsinbound).start();
    ...
    public ccasw_Search_Policy(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    private ccasw_ticket Tic;
    public ccasw_Search_Policy(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
    private ccasw_InBoundCall Inc;
    public ccasw_Search_Policy(ccasw_InBoundCall inc){
        this();
        this.Inc=inc;
    }
    public ccasw_Sms_income Sin;
    public ccasw_Search_Policy(ccasw_Sms_income sin){
        this();
        this.Sin=sin;
    }
    public ccasw_Email_incoming Ein;
    public ccasw_Search_Policy(ccasw_Email_incoming ein){
        this();
        this.Ein=ein;
    }
    private ccasw_ProgressBar Prg;
    public ccasw_Search_Policy(ccasw_ProgressBar prg){
        this();
        this.Prg=prg;
    }
    ...
    public static javax.swing.table.DefaultTableModel getDefaultTabelcus(){
        return new javax.swing.table.DefaultTableModel(
                new Object [][]{},
                new String [] {"No.","Insured Name","QQ Name","Policy No","Cover Note No","Cert No.","Class of Bussiness Name"}){
    ...
    public static void tabelcus(){
        tabcus.setRowCount(0);
        try{
            sql="select *  from ws_search_policy"
            ...
            while(rs.next()){
                ...
                cus[2]=rs.getString("qq_name");
                cus[3]=rs.getString("policy_no");
                cus[4]=rs.getString("cover_note_no");
                cus[5]=rs.getString("cert_no");
    ...
    private void initComponents() {
        ...
        txtQqName = new javax.swing.JTextField();
        dtIs1 = new com.toedter.calendar.JDateChooser();
        dtIs2 = new com.toedter.calendar.JDateChooser();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Search Policy", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10))); // NOI18N
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(1450, 40));
        jPanel2.setLayout(null);

        txtNama.setFont(txtNama.getFont().deriveFont((float)11));
        jPanel2.add(txtNama);
        txtNama.setBounds(210, 10, 150, 24);

        txtNota.setFont(txtNota.getFont().deriveFont((float)11));
        jPanel2.add(txtNota);
        txtNota.setBounds(370, 10, 130, 24);

        jLabel5.setFont(jLabel5.getFont().deriveFont((float)11));
        jLabel5.setText("Insured Nama");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(210, 0, 80, 10);
        ...
        jLabel7.setText("Nota No");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(370, 0, 80, 10);

        jLabel8.setFont(jLabel8.getFont().deriveFont((float)11));
        jLabel8.setText("Document Type");
        jPanel2.add(jLabel8);
        jLabel8.setBounds(510, 0, 80, 10);

        jLabel9.setFont(jLabel9.getFont().deriveFont((float)11));
        jLabel9.setText("Class of Bussiness ID");
        jPanel2.add(jLabel9);
        jLabel9.setBounds(860, 0, 110, 10);

        jLabel10.setFont(jLabel10.getFont().deriveFont((float)11));
        jLabel10.setText("QQ Name");
        jPanel2.add(jLabel10);
        jLabel10.setBounds(1060, 0, 110, 10);

        txtQqName.setFont(txtQqName.getFont().deriveFont((float)11));
        jPanel2.add(txtQqName);
        txtQqName.setBounds(1060, 10, 130, 24);

        dtIs1.setDateFormatString("dd-MMM-yyyy");
        dtIs1.setFont(dtIs1.getFont().deriveFont((float)11));
        jPanel2.add(dtIs1);
        dtIs1.setBounds(1200, 10, 120, 24);

        dtIs2.setDateFormatString("dd/MM/yyyy");
        dtIs2.setFont(dtIs2.getFont().deriveFont((float)11));
        jPanel2.add(dtIs2);
        dtIs2.setBounds(1320, 10, 120, 24);

        jLabel55.setFont(jLabel55.getFont().deriveFont((float)11));
        jLabel55.setText("Isurance Start");
        jPanel2.add(jLabel55);
        jLabel55.setBounds(1200, 0, 80, 10);

        jLabel56.setFont(jLabel56.getFont().deriveFont((float)11));
        jLabel56.setText("Insurance End");
        jPanel2.add(jLabel56);
        jLabel56.setBounds(1320, 0, 80, 10);

        jLabel11.setFont(jLabel11.getFont().deriveFont((float)11));
        jLabel11.setText("Document Number");
        jPanel2.add(jLabel11);
        jLabel11.setBounds(710, 0, 110, 10);

        txtDocNo.setFont(txtDocNo.getFont().deriveFont((float)11));
        jPanel2.add(txtDocNo);
        txtDocNo.setBounds(710, 10, 140, 24);

        jPanel2.add(cbCob);
        cbCob.setBounds(860, 10, 170, 24);

        jPanel2.add(cbBranch);
        cbBranch.setBounds(10, 10, 170, 24);

        jPanel2.add(cbDoc);
        cbDoc.setBounds(510, 10, 170, 24);
        ...
        jButton2.setBounds(680, 10, 20, 23);
        ...
        jButton3.setBounds(1030, 10, 20, 23);
...
//                        case 1:
    ...
    //
    //                        Tic.showcus();
//                            Inc.IdCust=((String)tblcus.getValueAt(tblcus.getSelectedRow(),tblcus.getTableHeader().getColumnModel().getColumnIndex("Policy No")));
//                            Inc.txtIdCust.setText((String)tblcus.getValueAt(tblcus.getSelectedRow(),tblcus.getTableHeader().getColumnModel().getColumnIndex("Policy No")));
//                            Inc.tabeltic();
//                            break;
//                        case 2:
                            sql1 = "insert into ws_request set request_time=CURRENT_TIMESTAMP "
                                    ...
                                    + ",function_id=5"
                                    + ",ws_params='"+(String)tblcus.getValueAt(tblcus.getSelectedRow(),tblcus.getTableHeader().getColumnModel().getColumnIndex("Policy No"))+".'"
                                    + "";
                            CCanj.jconn.SQLExecute(sql1, CCanj.conn);
...
//                    }
                    ...
                    Logger.getLogger(ccasw_Search_Policy.class.getName()).log(Level.SEVERE, null, ex);
                }
//                dispose();
            }
        }
    ...
    private void btnsrchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsrchActionPerformed
        // TODO add your handling code here:
        try {
            getbranch();getcob();getdoctype();
            Date dt5 =dtIs1.getDate();
            Date dt6 =dtIs2.getDate();
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy");
            if(dt5!=null){                start = sdf.format(dt5);            }else{                start="";            }
            if(dt6!=null){                end = sdf.format(dt6);            }else{                end ="";            }
            // TODO add your handling code here:
            sql1 = "insert into ws_request set request_time=CURRENT_TIMESTAMP "
                    + ",username='" + CCanj.lbluser.getText() + "'"
                    + ",function_id=4"
                    + ",ws_params='" + branchid + "|" + txtNama.getText() + "|" + txtNota.getText() + "|" + docid + "|" + txtDocNo.getText() + ""
                    + "|" + cobid + "|" + txtQqName.getText() + "|" + start + "|" + end + ".'"
                    + "";
            CCanj.jconn.SQLExecute(sql1, CCanj.conn);
            sqlid = "select distinct last_insert_id() from ws_request";
            rs = CCanj.jconn.SQLExecuteRS(sqlid, CCanj.conn);
    ...
    private void btnsrchMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnsrchMouseEntered
        // TODO add your handling code here:
//        if(dtIs1.getDate()!=null&&dtIs2.getDate()==null){
//            JOptionPane.showMessageDialog(null, "End date cannot be empty","Error!!!",JOptionPane.WARNING_MESSAGE);
//        }else if(dtIs1.getDate()==null&&dtIs2.getDate()!=null){
//            JOptionPane.showMessageDialog(null, "Start date cannot be empty","Error!!!",JOptionPane.WARNING_MESSAGE);
//        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        cbDoc.setSelectedIndex(-1);txtDocNo.setText("");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_Search_Policy().setVisible(true);
            }
        });
    }
    ...
    public static com.toedter.calendar.JDateChooser dtIs1;
    public static com.toedter.calendar.JDateChooser dtIs2;
    ...
    public static javax.swing.JTextField txtDocNo;
    public static javax.swing.JTextField txtNama;
    public static javax.swing.JTextField txtNota;
    public static javax.swing.JTextField txtQqName;
...
//            dialog.show();
    ...
    private void doctype(){
        ...
        try{
            sql="select data from _ws_document_type";
            rs=CCanj.jconn.SQLExecuteRS(sql,CCanj.conn);
            while(rs.next()){
                cbDoc.addItem(rs.getString(1));
            }
            cbDoc.setSelectedIndex(-1);
            action1=true;
        }catch(Exception e){
            System.out.println(e);
        }
    ...
    private void getdoctype(){
        docid="";
        try{
            sql="select code from _ws_document_type where data='"+cbDoc.getSelectedItem()+"'";
            rs=CCanj.jconn.SQLExecuteRS(sql,CCanj.conn);
            while(rs.next()){
                docid=(rs.getString(1).toString());
            }
        }catch(Exception e){
            System.out.println(e);
        }
