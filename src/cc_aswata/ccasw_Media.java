 ...
 * @author jsm
 */
public class ccasw_Media extends javax.swing.JFrame {
...
//        tabelmedia();
    ...
    public ccasw_Media(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    private ccasw_ticket Tic;
    public ccasw_Media(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }

    private ccasw_Add_note Add;
    public ccasw_Media(ccasw_Add_note add){
        this();
        this.Add=add;
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_Media().setVisible(true);
            }
        });
    }
