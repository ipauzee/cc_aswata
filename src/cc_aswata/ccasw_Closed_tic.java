 ...
 * @author jsm
 */
public class ccasw_Closed_tic extends javax.swing.JFrame {

    public static int conf=1;
    /** Creates new form ccasw_Closed_tic */
    public ccasw_Closed_tic() {
        initComponents();
    }

    private ContactCenterASWATA CCanj;
    public ccasw_Closed_tic(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    private ccasw_ticket Tic;
    public ccasw_Closed_tic(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        sql1="insert into log_mail (mail_from,mail_to,mail_subject,mail_text,ticket_id,direction,username) values ('contact@anjrent.com','"+Tic.txtTowMail.getText()+"','<notify>#"+Tic.txtcusnam.getText()+"#"+Tic.cbCategory.getSelectedItem()+"#"+Tic.txtnotic.getText()+"','CLOSED by : "+CCanj.lbluser.getText()+"\n"+opdt+"\n"+optm+"\n\nDetails :\n"+Tic.txtdetails.getText()+"\n\nSoluiton :\n"+Tic.txtlastnote.getText()+"','"+Tic.id+"',1,'"+CCanj.lbluser.getText()+")";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_Closed_tic().setVisible(true);
            }
        });
    }
