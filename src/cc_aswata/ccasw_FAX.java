 ...
 * @author jsm
 */
public class ccasw_FAX extends javax.swing.JFrame {
    String s;
    public static int z;
...
//        conn=(Connection) jconn.ConnectToMySQL("localhost","cc_anj","cc_anj","123jaring456");
    ...
    public ccasw_FAX(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    public static ccasw_Search_ticket Sct;
    public ccasw_FAX(ccasw_Search_ticket sct){
        this();
        this.Sct=sct;
    }
    private ccasw_ticket Tic;
    public ccasw_FAX(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
    private ccasw_Fax_incoming Fin;
    public ccasw_FAX(ccasw_Fax_incoming fin){
        this();
        this.Fin=fin;
    }
...
//        sql1="insert into log_mail (mail_from,mail_to,mail_subject,mail_text,ticket_id,direction,username) values ('contact@anjrent.com','"+txtcsomail.getText()+"','<Ticket>#"+txtcusnam.getText()+"#"+cbnoplat.getSelectedItem()+"#"+txtusr.getText()+"#"+cbcategory.getSelectedItem()+"#"+txtnotic.getText()+"','"+txtdetails.getText()+"\n\n"+txtsolution.getText()+" \n\n UPDATED','"+id+"',1,'"+CCanj.lbluser.getText()+"')";
            ...
            Logger.getLogger(ccasw_FAX.class.getName()).log(Level.SEVERE, null, ex);
        }
