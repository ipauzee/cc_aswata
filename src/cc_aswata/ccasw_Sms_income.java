 ...
 * @author jsm
 */
public class ccasw_Sms_income extends javax.swing.JFrame {
    public static int z;
    public static int zz;
    public static int sid=0;
    private boolean selected;

    /** Creates new form ccasw_Sms_income */
    public ccasw_Sms_income() {
        initComponents();
        open();
        showCaltype();
        showCust();
    ...
    public ccasw_Sms_income(ccasw_Search_ticket sct){
        this();
        this.Sct=sct;
    }
    public static ContactCenterASWATA CCanj;
    public ccasw_Sms_income(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    public static ccasw_SMS sMs;
    public ccasw_Sms_income(ccasw_SMS smS){
        this();
        this.sMs=smS;
    }
    private ccasw_ticket Tic;
    public ccasw_Sms_income(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_Sms_income().setVisible(true);
            }
        });
    }
