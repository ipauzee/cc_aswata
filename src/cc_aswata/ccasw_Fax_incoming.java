 ...
 * @author jsm
 */
public class ccasw_Fax_incoming extends javax.swing.JFrame {
    public static int z;
    ...
    /** Creates new form ccasw_Fax_incoming */
    public ccasw_Fax_incoming() {
        initComponents();
        showCust();
        setSize(1024,768);
    }
    ...
    public ccasw_Fax_incoming(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    public static ccasw_Search_ticket Sct;
    public ccasw_Fax_incoming(ccasw_Search_ticket sct){
        this();
        this.Sct=sct;
    }
    private ccasw_ticket Tic;
    public ccasw_Fax_incoming(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
    private ccasw_FAX Fax;
    public ccasw_Fax_incoming(ccasw_FAX fax){
        this();
        this.Fax=fax;
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_Fax_incoming().setVisible(true);
            }
        });
    }
...
//    public static Connection conn;
    ...
    public static void open(){
        ...
        try {
            ...
            Logger.getLogger(ccasw_Fax_incoming.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    private void opdt(){
          try{
