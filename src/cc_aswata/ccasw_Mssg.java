 ...
 * @author jsm
 */
public class ccasw_Mssg extends javax.swing.JFrame {
...
//        setModalityType(JDialog.ModalityType.APPLICATION_MODAL);
    ...
    public ccasw_Mssg(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    ...
    private void initComponents() {
        ...
        txttu.setFont(new java.awt.Font("Calibri", 0, 14));
        txttu.setText("<none>");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_Mssg().setVisible(true);
            }
        });
    }
