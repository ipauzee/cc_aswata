 ...
 * @author jsm
 */
public class ccasw_FAX1 extends javax.swing.JFrame {
    String s;
    String nmfile;
    String fullnmfile;
   ...
   Timer receiv;
    ...
    public ccasw_FAX1(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    private ccasw_ticket Tic;
    public ccasw_FAX1(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_FAX1().setVisible(true);
            }
        });
    }
