 ...
 * @author jsm
 */
public class ccasw_History extends javax.swing.JFrame {
    ...
    /** Creates new form ccasw_History */
    public ccasw_History() {
        initComponents();
        setSize(800,650);
    ...
    public ccasw_History(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    private ccasw_ticket Tic;
    public ccasw_History(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }

    private ccasw_Add_note Add;
    public ccasw_History(ccasw_Add_note add){
        this();
        this.Add=add;
    }
    ...
    private void btnsaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnsaveMouseClicked
        ...
        optm();
        usrlvl();
        ccasw_Add_note add=new ccasw_Add_note();
        add.setVisible(true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_History().setVisible(true);
            }
        });
    }
...
//                if((rs.getString(5)!=null)){
                   lblticno.setText("Ticket No    : "+rs.getString("notic")+" ");
//                }
