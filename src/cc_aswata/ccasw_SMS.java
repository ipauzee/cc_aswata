 ...
 * @author jsm
 */
public class ccasw_SMS extends javax.swing.JFrame {
...
//        p=limit.length();
    ...
    public ccasw_SMS(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    private ccasw_ticket Tic;
    public ccasw_SMS(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
    ...
    private void initComponents() {
        ...
        lbllimit.setBounds(110, 150, 18, 20);
