 ...
 * @author jsm
 */
public class ccasw_Add_note extends javax.swing.JFrame {

        public static int status=0;
    private int asdep;
    private String solution;

    /** Creates new form ccasw_Add_note */
    public ccasw_Add_note() {
        initComponents();
    }

    private ccasw_History Hic;
    public ccasw_Add_note(ccasw_History hic){
        this();
        this.Hic=hic;
    }
    public static ContactCenterASWATA CCanj;
    public ccasw_Add_note(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_Add_note().setVisible(true);
            }
        });
    }
