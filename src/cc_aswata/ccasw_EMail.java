 ...
 * @author jsm
 */
public class ccasw_EMail extends javax.swing.JFrame {
    ...
    public ccasw_EMail(ccasw_login log){
        this();
        this.Log=log;
    }
    public static ContactCenterASWATA CCanj;
    public ccasw_EMail(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    public static ccasw_ticket Tic;
    public ccasw_EMail(ccasw_ticket tic){
        this();
        this.Tic=tic;
    }
...
//        lbldirection.setText("OutBound");
    ...
    private void btnmsendMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnmsendMouseClicked
        ...
        optm();
        stt();
        sql="insert into log_mail (mail_from,mail_to,mail_cc,mail_subject,mail_text,direction,username,ticket_id,direction_type) values ('contact@mpm-rent.com','"+txtcto.getText()+"','"+txtccc.getText()+"','"+txtcsu.getText()+"','"+txtcmsg.getText()+"',1,'"+CCanj.lbluser.getText()+"','"+id+"','"+cbcaltype.getSelectedItem()+"')";
//        sql1="insert into log_mail (mail_from,mail_to,mail_subject,mail_text,ticket_id,direction,username) values ('contact@anjrent.com','"+txtcsomail.getText()+"','<Ticket>#"+txtcusnam.getText()+"#"+cbnoplat.getSelectedItem()+"#"+txtusr.getText()+"#"+cbcategory.getSelectedItem()+"#"+txtnotic.getText()+"','"+txtdetails.getText()+"\n\n"+txtsolution.getText()+" \n\n UPDATED','"+id+"',1,'"+CCanj.lbluser.getText()+"')";
        ...
        try {
            ...
            Logger.getLogger(ccasw_EMail.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_EMail().setVisible(true);
            }
        });
    }
