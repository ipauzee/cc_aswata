 ...
 * @author jsm
 */
public class ccasw_login extends javax.swing.JFrame {
...
//            lbllogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/konica_minolta_logo_clear.gif")));
    ...
    public static void setKoneksi(){
        switch (version) {
            case Loc:
                conn=(Connection) jconn.ConnectToMySQL("localhost","cc_aswata","root","");
                break;

            case Dev:
                conn=(Connection) jconn.ConnectToMySQL("192.168.0.88","cc_aswata","root","j@r1ng");
                ftpuser="aswata_mail";
                ftpserver="192.168.0.88";
                ftpuserRec="aswata";
                ftpserverRec="192.168.0.6";
                break;
            case Pro:
                conn=(Connection) jconn.ConnectToMySQL("192.168.0.17","cc_aswata?useUnicode=true&characterEncoding=utf8","cc_aswata","cc_aswata");
                ftpuser="aswata_mail";
                ftpserver="192.168.0.17";
                ftpuserRec="cc_aswata";
                ftpserverRec="192.168.0.17";
                break;
        }
    }

    private ContactCenterASWATA CCanj;
    public ccasw_login(ContactCenterASWATA ccanj){
        this();
        this.CCanj=ccanj;
    }
    ...
    private void initComponents() {
        ...
        setTitle("Contact Center Asuransi Wahana Tata");
        setResizable(false);
        ...
        jPanel3.add(jPanel1);
        jPanel1.setBounds(630, 420, 310, 130);
        ...
        jPanel3.add(jPanel2);
        jPanel2.setBounds(670, 570, 230, 50);

        lbllogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Aswata Logo1.jpg"))); // NOI18N
        jPanel3.add(lbllogo);
        lbllogo.setBounds(0, 0, 1020, 350);
...
//                System.out.println(data[0]);
        ...
        //                            System.out.println(sql);
                                    ...
                                    ContactCenterASWATA ccanj = new ContactCenterASWATA();
                                    jdp.add(ccanj);
                                    ccanj.show();
                                    bersih();
...
//                            conn.close();
            ...
            Logger.getLogger(ccasw_login.class.getName()).log(Level.SEVERE, null, ex);
        }                            
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ccasw_login().setVisible(true);
            }
        });
    }
